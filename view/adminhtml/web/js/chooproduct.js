...
require([
    ...
    /**
     * event chosen orders list
     */
    // async.async('[data-index="category_id"] select', function () {
    //     $(document).ready(function () {
    //         $('[data-index="category_id"] select').chosen({search_contains: true});
    //     });
    // });
    async.async('[data-index="product_ids"] select', function () {
        $(document).ready(function () {
            $('[data-index="product_ids"] select').chosen({search_contains: true});
        });
    });
